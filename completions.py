		...
		if view.match_selector(view.line(locations[0]).a, "comment.mkb"):
			...
			# Control Flow
				...
				sublime.CompletionItem( #elseif
					...
					completion=case("elseif")+args("${1:<condition>}")+";"+"\n	$0"),
				...
				sublime.CompletionItem( #for
					...
					completion=case("for")+args("#${1:<var>},${2:<start>},${3:<end>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #for
					trigger=case("for"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
					...
					details="Begins a for loop", 
					completion=case("for")+args("#${1:<var>} = ${2:<start>} to ${3:<end>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #for
					trigger=case("for"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
					...
					details="Begins a for loop", 
					completion=case("for")+args("#${1:<var>} = ${2:<start>} to ${3:<end>} step ${4:<step>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #foreach
					...
					completion=case("foreach")+args("${1:<iterator>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #foreach
					trigger=case("foreach"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
					...
					details="Begins a loop over the specified iterator", 
					completion=case("foreach")+args("${1:<array>}[],${2:<content>},#${3:[index]}")+";"+"\n	$0\nnext"+";"),
				sublime.CompletionItem( #foreach
					trigger=case("foreach"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
					...
					details="Begins a loop over the specified iterator", 
					completion=case("foreach")+args("${1:<array>}[] as &${2:<content>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #foreach
					trigger=case("foreach"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
					...
					details="Begins a loop over the specified iterator", 
					completion=case("foreach")+args("${1:<array>}[] as #${2:<index>} => ${3:<content>}")+";"+"\n	$0\n"+case("next")+";"),
				sublime.CompletionItem( #do
					...
					completion=case("do")+args("${1:[count]}")+";"+"\n	$0\n"+case("loop")+";"),
				sublime.CompletionItem( #do
					trigger=case("do"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_SNIPPET, 
				...
				sublime.CompletionItem( #while
					...
					completion=case("while")+args("${1:<condition>}")+";"+"\n$0"),
				sublime.CompletionItem( #until
					...
					completion=case("until")+args("${1:<condition>}")+";"+"\n$0"),
				...
				sublime.CompletionItem( #ifbeginswith
					...
					completion=case("ifbeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifcanharvestblock
					...
					completion=case("ifcanharvestblock")+args("${1:<blockid>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifcontains
					...
					completion=case("ifcontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifenchanted
					...
					completion=case("ifenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifendswith
					...
					completion=case("ifendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #iffileexists
					...
					completion=case("iffileexists")+args("${1:<path>},${2:[expression]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifininv
					...
					completion=case("ifininv")+args("${1:[mode]},${2:<items>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifinvisfull
					...
					completion=case("ifinvisfull")+args("${1:[item]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifmatches
					...
					completion=case("ifmatches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n	$0\n"+case("endif")+";"),
				...
				sublime.CompletionItem( #ifnotbeginswith
					...
					completion=case("ifnotbeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotcanharvestblock
					...
					completion=case("ifnotcanharvestblock")+args("${1:<blockid>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotcontains
					...
					completion=case("ifnotcontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotenchanted
					...
					completion=case("ifnotenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotendswith
					...
					completion=case("ifnotendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotfileexists
					...
					completion=case("ifnotfileexists")+args("${1:<path>},${2:[expression]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotininv
					...
					completion=case("ifnotininv")+args("${1:[mode]},${2:<items>}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotinvisfull
					...
					completion=case("ifnotinvisfull")+args("${1:[item]}")+";"+"\n	$0\n"+case("endif")+";"),
				sublime.CompletionItem( #ifnotmatches
					...
					completion=case("ifnotmatches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n	$0\n"+case("endif")+";"),
				...
				sublime.CompletionItem( #elseifbeginswith
					...
					completion=case("elseifbeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifcanharvestblock
					...
					completion=case("elseifcanharvestblock")+args("${1:<blockid>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifcontains
					...
					completion=case("elseifcontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifenchanted
					...
					completion=case("elseifenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifendswith
					...
					completion=case("elseifendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseiffileexist
					...
					completion=case("elseiffileexists")+args("${1:<path>},${2:[expression if file should be created if missing]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifininv
					...
					completion=case("elseifininv")+args("${1:[mode]},${2:<items>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifinvisfull
					...
					completion=case("elseifinvisfull")+args("${1:[item]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifmatches
					...
					completion=case("elseifmatches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n	$0"),
				...
				sublime.CompletionItem( #elseifnotbeginswith
					...
					completion=case("elseifnotbeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotcanharvestblock
					...
					completion=case("elseifnotcanharvestblock")+args("${1:<blockid>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotcontains
					...
					completion=case("elseifnotcontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotenchanted
					...
					completion=case("elseifnotenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotendswith
					...
					completion=case("elseifnotendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotfileexist
					...
					completion=case("elseifnotfileexists")+args("${1:<path>},${2:[expression if file should be created if missing]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotininv
					...
					completion=case("elseifnotininv")+args("${1:[mode]},${2:<items>}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotinvisfull
					...
					completion=case("elseifnotinvisfull")+args("${1:[item]}")+";"+"\n	$0"),
				sublime.CompletionItem( #elseifnotmatches
					...
					completion=case("elseifnotmatches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n	$0"),
				...
				sublime.CompletionItem( #whilebeginswith
					...
					completion=case("whilebeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #whilecanharvestblock
					...
					completion=case("whilecanharvestblock")+args("${1:<blockid>}")+";"+"\n$0"),
				sublime.CompletionItem( #whilecontains
					...
					completion=case("whilecontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #whileenchanted
					...
					completion=case("whileenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n$0"),
				sublime.CompletionItem( #whileendswith
					...
					completion=case("whileendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #whilefileexist
					...
					completion=case("whilefileexists")+args("${1:<path>},${2:[expression if file should be created if missing]}")+";"+"\n$0"),
				sublime.CompletionItem( #whileininv
					...
					completion=case("whileininv")+args("${1:[mode]},${2:<items>}")+";"+"\n$0"),
				sublime.CompletionItem( #whileinvisfull
					...
					completion=case("whileinvisfull")+args("${1:[item]}")+";"+"\n$0"),
				sublime.CompletionItem( #whilematches
					...
					completion=case("whilematches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n$0"),
				...
				sublime.CompletionItem( #untilbeginswith
					...
					completion=case("untilbeginswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #untilcanharvestblock
					...
					completion=case("untilcanharvestblock")+args("${1:<blockid>}")+";"+"\n$0"),
				sublime.CompletionItem( #untilcontains
					...
					completion=case("untilcontains")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #untilenchanted
					...
					completion=case("untilenchanted")+args("${1:<slot>},&${2:[item]},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"+"\n$0"),
				sublime.CompletionItem( #untilendswith
					...
					completion=case("untilendswith")+args("${1:<haystack>},${2:<needle>}")+";"+"\n$0"),
				sublime.CompletionItem( #untilfileexist
					...
					completion=case("untilfileexists")+args("${1:<path>},${2:[expression if file should be created if missing]}")+";"+"\n$0"),
				sublime.CompletionItem( #untilininv
					...
					completion=case("untilininv")+args("${1:[mode]},${2:<items>}")+";"+"\n$0"),
				sublime.CompletionItem( #untilinvisfull
					...
					completion=case("untilinvisfull")+args("${1:[item]}")+";"+"\n$0"),
				sublime.CompletionItem( #untilmatches
					...
					completion=case("untilmatches")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]}")+";"+"\n$0"),
				...
				sublime.CompletionItem( #unsafe
					...
					completion=case("unsafe")+args("${1:<executions>}")+";"+"\n	$0\n"+case("endunsafe")+";"),
			...
			# My custom completions
				...
				sublime.CompletionItem( #print
					...
					completion=case("print")+args("${1:<text>}")+";"),
			...
			# AEI Module
				sublime.CompletionItem( #getiteminfo
					...
					completion=case("getiteminfo")+args("${1:<slot>},&${2:[idvar]},#${3:[stacksize]},#${4:[datavar]},&${5:[display]},&${6:[lore]}")+";"),
				sublime.CompletionItem( #getguiname
					...
					completion=case("getguiname")+args("&${1:<name>}")+";"),
				sublime.CompletionItem( #invfull
					...
					completion=case("invfull")+args("&${1:<string>}")+";"),
			...
			# anvilRename Module
				sublime.CompletionItem( #setanviltext
					...
					completion=case("setanviltext")+args("${1:<string>}")+";"),
			...
			# BaritoneAddon Module
				sublime.CompletionItem( #baritone
					...
					completion=case("baritone")+args("${1:<command>}")+";"),
				sublime.CompletionItem( #goto
					...
					completion=case("goto")+args("${1:<x>},${2:<y>},${3:<z>}")+";"),
				sublime.CompletionItem( #setting
					...
					completion=case("setting")+args("${1:<settingname>},${2:<value>}")+";"),
				...
				sublime.CompletionItem( #mine
					...
					completion=case("mine")+args("${1:<blockname>}")+";"),
				...
				sublime.CompletionItem( #selstart
					...
					completion=case("selstart")+args("${1:<x>},${2:<y>},${3:<z>}")+";"),
				sublime.CompletionItem( #selend
					...
					completion=case("selend")+args("${1:<x>},${2:<y>},${3:<z>}")+";"),
				...
				sublime.CompletionItem( #selreplace
					...
					completion=case("selreplace")+args("${1:<blocktoreplace>},${2:<replacementblock>}")+";"),
				sublime.CompletionItem( #BARITONE
					trigger="BARITONE", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
			...
			# charModule
				sublime.CompletionItem( #char
					...
					completion="&${1:<char>} = "+case("char")+args("${2:<decimal unicode value>}")+";"),
			...
			# Clipboard Module
				...
				sublime.CompletionItem( #getclipboard
					...
					completion=case("getclipboard")+args("&${1:[text]}")+";"),
				sublime.CompletionItem( #setclipboard
					...
					completion=case("setclipboard")+args("${1:<text>}")+";"),
			...
			# Cloudscript Module
				sublime.CompletionItem( #run
					...
					completion=case("run")+args("${1:<cloudscript>}")+";"),
				sublime.CompletionItem( #addanim
					...
					completion=case("addanim")+args("&${1:<array>}[]")+";"),
				sublime.CompletionItem( #event
					...
					completion=case("event")+args("${1:<projectId>}")+";"),
				...
				sublime.CompletionItem( #getkeybind
					...
					completion=case("getkeybind")+args("${1:<key>},&${2:<outvar>}")+";"),
				sublime.CompletionItem( #setkeybind
					...
					completion=case("setkeybind")+args("${1:<key>},${2:<some code>}")+";"),
				sublime.CompletionItem( #return
					...
					completion=case("return")+args("${1:<anything>}")+";"),
				sublime.CompletionItem( #sendmessage
					...
					completion=case("sendmessage")+args("${1:<channel>},${2:<message>}")+";"),
				sublime.CompletionItem( #encrypt
					...
					completion=case("encrypt")+args("&${1:<var>},${2:<16charskey>}")+";"),
				sublime.CompletionItem( #decrypt
					...
					completion=case("decrypt")+args("&${1:<var>},${2:<16charskey>}")+";"),
				sublime.CompletionItem( #remove
					...
					completion=case("remove")+args("&${1:<array>}[],&${2:<outvar>},${3:[pos]}")+";"),
			...
			# Documentor Module
				sublime.CompletionItem( #adddocs
					...
					completion=case("adddocs")+args("${1:<name of entry>},${2:[usage]},${3:[description]},${4:[return type]}")+";"),
				sublime.CompletionItem( #listdocs
					...
					completion="&${1:docs}[] = "+case("listdocs")+args("${2:[name]}")+";"),
			...
			# Functions Module
				...
				sublime.CompletionItem( #return
					...
					completion=case("return")+args("${1:<value>}")+";"),
				sublime.CompletionItem( #return
					trigger=case("return"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_FUNCTION, 
				...
				sublime.CompletionItem( #call
					...
					completion=case("call")+args("${1:<name>},${2:[parameter], ...}")+";"),
			...
			# GetSlotItemExtended Module
				sublime.CompletionItem( #getslotitemext
					...
					completion=optional("${2:&${1:[itemid]} = }")+case("getslotitemext")+args("#${3:<slotid>},&${1:[itemid]},${4:[stacksize]},${5:[damage]},${6:[itemname]}")+";"),
				sublime.CompletionItem( #getslotitemnbt
					...
					completion=optional("${2:&${1:[itemid]} = }")+case("getslotitemnbt")+args("#${3:<slotid>},${1:[itemid]},${4:[stacksize]},${5:[damage]},${6:[nbt]}")+";"),
				sublime.CompletionItem( #getslotitemenchants
					...
					completion=optional("${2:&${1:[itemid]} = }")+case("getslotitemenchants")+args("#${3:<slotid>},${1:[itemid]},${4:[stacksize]},${5:[damage]},${6:[enchants]}")+";"),
			...
			# HTTP Module
				sublime.CompletionItem( #httpget
					...
					completion="${2:&${1:[response]}[] = }"+case("httpget")+args("${3:<url>},${4:<query>},#${5:<status>},&${1:[response]}")+";"),
				sublime.CompletionItem( #httppost
					...
					completion="${2:&${1:[response]}[] = }"+case("httppost")+args("${3:<url>},${4:<data>},#${5:<status>},&${1:[response]}")+";"),
				sublime.CompletionItem( #httpput
					...
					completion="${2:&${1:[response]}[] = }"+case("httpput")+args("${3:<url>},${4:<data>},#${5:<status>},&${1:[response]}")+";"),
				sublime.CompletionItem( #httpdelete
					...
					completion="${2:&${1:[response]}[] = }"+case("httpdelete")+args("${3:<url>},${4:<query>},#${5:<status>},&${1:[response]}")+";"),
				sublime.CompletionItem( #urlencode
					...
					completion="${2:&${1:[output]} = }"+case("urlencode")+args("${3:<string>},&${1:[output]}")+";"),
				sublime.CompletionItem( #setrequestheader
					...
					completion=case("setrequestheader")+args("&${1:<field>},&${2:<value>}")+";"),
			...
			# JSON Module
				sublime.CompletionItem( #isboolean
					...
					completion="${2:[${1:bool}] = }"+case("isboolean")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isfloat
					...
					completion="${2:${1:[bool]} = }"+case("isfloat")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isinteger
					...
					completion="${2:${1:[bool]} = }"+case("isinteger")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isjsonarray
					...
					completion="${2:${1:[bool]} = }"+case("isjsonarray")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isjsonobject
					...
					completion="${2:${1:[bool]} = }"+case("isjsonobject")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isjsonprimitive
					...
					completion="${2:${1:[bool]} = }"+case("isjsonprimitive")+args("${3:<string>}${1:,[bool}]")+";"),
				sublime.CompletionItem( #isnumber
					...
					completion="${2:${1:[bool]} = }"+case("isnumber")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #isstring
					...
					completion="${2:${1:[bool]} = }"+case("isstring")+args("${3:<string>},${1:[bool]}")+";"),
				sublime.CompletionItem( #jsonadd
					...
					completion="${2:&${1:[output]} = }"+case("jsonadd")+args("${3:<json>},${4:<key>},${5:<value>},&${1:[output]}")+";"),
				sublime.CompletionItem( #jsonget
					...
					completion="${2:&${1:[output]} = }"+case("jsonget")+args("${3:<json>},${4:<key>},&${1:[output]}")+";"),
				sublime.CompletionItem( #jsonhas
					...
					completion="${2:${1:[bool]} = }"+case("jsonhas")+args("${3:<json>},${4:<key>},${1:[bool]}")+";"),
				sublime.CompletionItem( #jsonremove
					...
					completion="${2:&${1:[output]} = }"+case("jsonremove")+args("${3:<json>},${4:<key>},&${1:[output]}")+";"),
				sublime.CompletionItem( #getjsonkeys
					...
					completion="${2:&${1:[keys]} = }"+case("getjsonkeys")+args("${3:<json>},&${1:[keys]}[]")+";"),
				sublime.CompletionItem( #getjsonarray
					...
					completion="${2:&${1:[array]} = }"+case("getjsonasarray")+args("${3:<json>},${1:[array]}[])")+";"),
				sublime.CompletionItem( #jsonarrayadd
					...
					completion="${2:&${1:[jsonarray]} = }"+case("jsonarrayadd")+args("${3:<jsonarray>},${4:<element>},&${1:[jsonarray]}")+";"),
				sublime.CompletionItem( #jsonarrayget
					...
					completion="${2:&${1:[output]} = }"+case("jsonarrayget")+args("${3:<jsonarray>},${4:<index>},&${1:[output]}")+";"),
				sublime.CompletionItem( #jsonarraysize
					...
					completion="${2:#${1:[size]} = }"+case("jsonarraysize")+args("${3:<jsonarray>},#${1:[size]}")+";"),
			...
			# Klacaiba Module
				sublime.CompletionItem( #calcyawto
					...
					completion=case("calcyawto")+args("${1:<xpos>},${2:<ypos>},${3:<zpos>},#${4:[yaw]},#${5:[dist]},#${6:[pitch]}")+";"),
				sublime.CompletionItem( #getslotitem
					...
					completion=case("getslotitem")+args("${1:<slotid>},&${2:<itemid>},#${3:[stacksize]},#${4:[datavar]},&${5:[nbt]}")+";"),
				sublime.CompletionItem( #http
					...
					completion=optional("&${1:response} = ")+case("http")+args("${2:[get|post|put|delete]},${3:<url>},${4:[output stream]},${5:[headers]}","$2")+";"),
				sublime.CompletionItem( #mkdir
					...
					completion=case("mkdir")+args("${1:<path>}")+";"),
				sublime.CompletionItem( #readfile
					...
					completion=optional("${2:&${1:<content>}[] = }")+case("readfile")+args("&${1:[content]}[],${3:<path>}")+";"),
				sublime.CompletionItem( #writefile
					...
					completion=case("writefile")+args("${1:<path>},&${2:<writefile>}[],${3:[append]}")+";"),
				sublime.CompletionItem( #getjsonasarray
					...
					annotation="(Klacaiba Module)", 
					details="Returns json as key:value array", 
					completion=optional("&${1:array}[] = ")+case("getjsonasarray")+args("${2:<json>},${3:[format]}")+";"),
				sublime.CompletionItem( #getjsonkeys
					trigger=case("getjsonkeys"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=optional("&${1:keys}[] = ")+case("getjsonkeys")+args("${2:<json>}")+";"),
				sublime.CompletionItem( #jsonget
					trigger=case("jsonget"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=optional("&${1:object} = ")+case("jsonget")+args("${2:<json>},${3:<key>}")+";"),
				sublime.CompletionItem( #sort
					...
					completion=case("sort")+args("${1:[asc,dsc]},${2:<array>}[],${3:[array]}[]")+";"),
				sublime.CompletionItem( #teammembers
					...
					completion=optional("&${1:<members/teams>}[] = ")+case("teammembers")+args("${2:[team]}")+";"),
				sublime.CompletionItem( #score
					...
					completion=optional("<${1:&score|&scores[]|&obectives[]}> = ")+case("score")+args("${2:[objectivename]},${3:[playername]}")+";"),
				sublime.CompletionItem( #countdownto
					...
					completion=case("countdownto")+args("${1:<until>}")+";"),
				sublime.CompletionItem( #countdownfrom
					...
					completion=case("countdownfrom")+args("${1:<start>}")+";"),
				...
				sublime.CompletionItem( #counter
					...
					completion=case("counter")+args("${1:<id>}")+";"),
				sublime.CompletionItem( #sectotime
					...
					completion=optional("&${1:time} = ")+case("sectotime")+args("${2:<seconds>},${3:[format]}")+";"),
				sublime.CompletionItem( #getchestname
					...
					completion=optional("&${1:name} = ")+case("getchestname")+"()"+";"),
				sublime.CompletionItem( #getemptyslots
					...
					completion=optional("#${1:slots} = ")+case("getemptyslots")+args("${2:[include non full slots]}")+";"),
				sublime.CompletionItem( #getmouseitem
					...
					completion=optional("${2:&${1:[id]} = }")+case("getmouseitem")+args("&${1:[id]},#${3:[stacksizevar]},#${4:[datavar]},&${5:[nbt]}")+";"),
				sublime.CompletionItem( #getslotiteminv
					...
					completion=optional("${2:[&${1:<id>}] = }")+case("getslotiteminv")+args("${3:<slotid>},&${1:<id>},#${4:[stacksizevar]},#${5:[datavar]},&${6:[nbt]}")+";"),
				sublime.CompletionItem( #getslotinv
					...
					completion=optional("#${1:[slot]} = ")+case("getslotinv")+args("${2:<item>}:${3:[damage]},#${4:<idvar>},${5:[startfromslotid]}")+";"),
				sublime.CompletionItem( #setslotitem
					...
					completion=case("setslotitem")+args("${1:<item>}:${2:[damage]}${3:,<slot>},${4:[amount]},${5:[nbt]}")+";"),
				sublime.CompletionItem( #getfishhook
					...
					completion=optional("${2:#${1:[ytotal]} = }")+case("getfishhook")+args("#${3:[x]},#${4:[xprecision]},#${5:[y]},#${6:[yprecision]},#${7:[z]},#${8:[zprecision]}")+";"),
				sublime.CompletionItem( #map
					...
					completion=optional("#${1:result} = ")+case("map")+args("${2:<x>},${3:<minfrom>},${4:<maxfrom>},${5:<minto>},${6:<maxto>}")+";"),
				sublime.CompletionItem( #particle
					...
					completion=optional("${2:&${1:errors}[] = }")+case("particle")+args("${3:<particlename>},${4:<x>},${5:<y>},${6:<z>},${7:<dx>},${8:<dy>},${9:<dz>},${10:[count]},${11:[mode]}")+";"),
				sublime.CompletionItem( #countitem
					...
					completion=optional("#${1:count} = ")+case("countitem")+args("${2:<item>}:${3:[damage]}")+";"),
				sublime.CompletionItem( #countiteminv
					...
					completion=optional("#${1:count} = ")+case("countiteminv")+args("${2:<item>}:${3:[damage]}")+";"),
				sublime.CompletionItem( #createcontrol
					...
					completion=optional("${2:[&${1:controlname}] = }")+case("createcontrol")+args("${3:<screenname|layouts|types>},${4:[element type]},${5:[row]},${6:[column]}")+";"),
				sublime.CompletionItem( #deletecontrol
					...
					completion=case("deletecontrol")+args("${1:<controlname>}")+";"),
				sublime.CompletionItem( #timestamptodate
					...
					completion=optional("&${1:date} = ")+case("timestamptodate")+args("${2:<timestamp>},${3:[in milliseconds|date format]},${4:[in milliseconds]}")+";"),
				sublime.CompletionItem( #stop
					...
					completion=case("stop")+args("${1:[array|regex]}")+";"),
				sublime.CompletionItem( #strlen
					...
					completion=optional("#${1:length} = ")+case("strlen")+args("${2:<string>}")+";"),
				sublime.CompletionItem( #getbreakspeed
					...
					completion=optional("#${1:ticks} = ")+case("getbreakspeed")+args("${2:<blockid>}")+";"),
				sublime.CompletionItem( #pollevent
					...
					completion=case("pollevent")+args("${1:[event]}")+";"+"\n	$0\n	"+case("await")+";"+"\n"+case("next")+";"),
				...
				sublime.CompletionItem( #char
					...
					completion=optional("${2:&${1:<result>} = }")+case("char")+args("&${1:<result>},&${3:<char expression>}")+";"),
				sublime.CompletionItem( #char
					trigger=case("char"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
				...
				sublime.CompletionItem( #unix
					...
					completion=case("unix")+args("#${1:[seconds]},#${2:<milliseconds>}")+";"),
			...
			# Macro Modules Essential
				sublime.CompletionItem( #getslotnbt
					...
					completion=case("getslotnbt")+args("${1:<slotid>},${2:<path>},&${3:[itemId]},#${4:[stackSize]},#${5:[damage]}")+";"),
				sublime.CompletionItem( #pressbutton
					...
					completion=case("pressbutton")+args("${1:<buttonid>},${2:[button]}")+";"),
				sublime.CompletionItem( #getprop
					...
					completion=case("getprop")+args("${1:<x>},${2:<y>},${3:<z>},${4:<propname>},#${5:[propvar]}")+";"),
				sublime.CompletionItem( #slotmiddleclick
					...
					completion=case("slotmiddleclick")+args("${1:<slotid>}")+";"),
			...
			# Reconnect Module
				sublime.CompletionItem( #reconnect
					...
					completion=case("reconnect")+args("${1:<on|off|10-300>}")+";"),
				sublime.CompletionItem( #RECONNECT
					trigger="RECONNECT", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
			...
			# scaneUtils Module
				sublime.CompletionItem( #getdensity
					...
					completion=case("getdensity")+args("${1:[N/E/S/W]},#${2:<limit_search>},&${3:<initial_position>},#${4:<blocks_searched>},#${5:<sugarcane_found>}")+";"),
				sublime.CompletionItem( #getitemstacksize
					...
					completion=optional("#${1:stacksize} = ")+case("getitemstacksize")+args("&${2:<item_name>},#${3:[limit_search]}")+";"),
				sublime.CompletionItem( #getpercentage
					...
					completion=case("getpercentage")+args("#${1:[percentage]},#${2:<first>},#${3:<second>}")+";"),
				sublime.CompletionItem( #getslotpositions
					...
					completion=case("getslotpositions")+args("&${1:<item_name>},#${2:<result_position>},#${3:[result_stacksize]}")+";"),
			...
			# SignText Module
				sublime.CompletionItem( #gethitsigntext
					...
					completion=optional("${2:&${1:[outarray]}[] = }")+case("gethitsigntext")+args("&${1:[outarray]}[]")+";"),
				sublime.CompletionItem( #getsigntext
					...
					completion=optional("${2:&${1:[outarray]} = }")+case("getsigntext")+args("${3:<x>},${4:<y>},${5:<z>},&${1:[outarray]}")+";"),
				sublime.CompletionItem( #setsigntext
					...
					completion=case("setsigntext")+args("${1:<x>},${2:<y>}${3:,<z>},${4:<line1>},${5:<line2>},${6:<line3>},${7:<line4>}")+";"),
			...
			# Switch Module
				sublime.CompletionItem( #switch
					...
					completion=case("switch")+args("${1:<expression>}")+";"+"\n	"+case("case")+args("${2:<value>}","$2")+";"+"\n		$0\n	"+case("default")+";"+"\n		\n"+case("endswitch")),
				sublime.CompletionItem( #case
					...
					completion=case("case")+args("${1:<value>}")+";"+"\n	$0"),
			...
			# Utilities Module
				sublime.CompletionItem( #eval
					...
					completion=optional("${2:&${1:[result]} = }")+case("eval")+args("&${1:[result]},${3:<expression string>}")+";"),
				sublime.CompletionItem( #char
					trigger=case("char"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=case("char")+args("&${1:<char>},${2:<decimal unicode value>}")+";"),
				sublime.CompletionItem( #mod
					...
					completion=case("mod")+args("#${1:<result>},${2:<num1>},${3:<num2>}")+";"),
				sublime.CompletionItem( #oldname
					...
					completion=case("oldname")+args("&${1:<names>}[],${2:<username>}")+";"),
				sublime.CompletionItem( #readfile
					trigger=case("readfile"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=case("readfile")+args("&${1:<content>}[],${2:<filename>}")+";"),
				sublime.CompletionItem( #unix
					trigger=case("unix"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=optional("${2:#${1:[seconds]} = }")+case("unix")+args("#${1:[seconds]},#${3:[milliseconds]}")+";"),
				sublime.CompletionItem( #eval
					trigger=case("eval"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=optional("${3:${2:[&#]}${1:<result>} = }")+case("eval")+args("${2:[&#]}${1:<result>},${4:<expression>}")+";"),
				sublime.CompletionItem( #mod
					trigger=case("mod"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=optional("${2:#${1:[result]} = }")+case("mod")+args("#${1:[result]},${3:<dividend>},${4:<divisor>}")+";"),
				...
				sublime.CompletionItem( #oldname
					...
					completion=optional("${2:&${1:result}[] = }")+case("oldname")+args("&${1:<result>}[],${3:<name|uuid>}")+";"),
			...
			# Utils Module
				sublime.CompletionItem( #trim
					...
					completion=optional("&${1:result} = ")+case("trim")+args("&${2:string}")+";"),
				sublime.CompletionItem( #shuffle
					...
					completion=case("shuffle")+args("${1:array[]}")+";"),
			...
			# WindowsNotifications Module
				sublime.CompletionItem( #notify
					...
					completion=case("notify")+args("${1:[title]},${2:[message]}")+";"),
			...
			# Yaku Module
				sublime.CompletionItem( #mod
					...
					completion=case("mod")+args("#${1:<divident>},#${2:<divisor>}")+";"),
				sublime.CompletionItem( #trunc
					...
					completion=case("trunc")+args("#${1:<float>}")+";"),
				sublime.CompletionItem( #ackermann
					...
					completion=case("ackermann")+args("#${1:<m>},#${2:<n>}")+";"),
				sublime.CompletionItem( #calcstacks
					...
					completion=case("calcstacks")+args("#${1:<items>},#${2:[stacks]},#${3:[leftovers]}")+";"),
				sublime.CompletionItem( #pickmod
					...
					completion=case("pickmod")+args("${1:[namespace]}:${2:<itemid>}:${3:[damage]},${4:[addInCreative]}")+";"),
			...
			# BetterEcho
				sublime.CompletionItem( #betterecho
					...
					completion=case("betterecho")+args("${1:<text>}")+";"),
			...
			# Trace variable
				sublime.CompletionItem( #trace
					...
					completion=case("trace")+args("${1:<distance>},${2:[entities]}")+";"),
			...
			# MKB Default
				sublime.CompletionItem( #achievementget
					...
					completion=case("achievementget")+args("${1:<text>},${2:[itemid]}:${3:[damage]}")+";"),
				...
				sublime.CompletionItem( #arraysize
					...
					completion=case("arraysize")+args("${1:<array>}[],#${2:[outvar]}")+";"),
				sublime.CompletionItem( #assign
					...
					completion=optional("${1:<var>}")+" = "+optional("${2:<value>}")+";"),
				...
				sublime.CompletionItem( #bind
					...
					completion=case("bind")+args("${1:<bind>},${2:<keycode>}")+";"),
				sublime.CompletionItem( #bindgui
					...
					completion=case("bindgui")+args("${1:<slot>},${2:<screen>}")+";"),
				...
				sublime.CompletionItem( #calcyawto
					...
					completion=case("calcyawto")+args("${1:<xpos>},${2:<zpos>},#${3:[yaw]},#${4:[dist}ance]")+";"),
				sublime.CompletionItem( #camera
					...
					completion=case("camera")+args("${1:[mode]}")+";"),
				sublime.CompletionItem( #CAMERA
					trigger="CAMERA", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #chatfilter
					...
					completion=case("chatfilter")+args("${1:<enabled>}")+";"),
				sublime.CompletionItem( #chatheight
					...
					completion=case("chatheight")+args("${1:<value>},${2:[time]}")+";"),
				sublime.CompletionItem( #chatheightfocused
					...
					completion=case("chatheightfocused")+args("${1:<value>},${2:[time]}")+";"),
				...
				sublime.CompletionItem( #chatopacity
					...
					completion=case("chatopacity")+args("${1:<value>},${2:[time]}")+";"),
				...
				sublime.CompletionItem( #chatscale
					...
					completion=case("chatscale")+args("${1:<value>},${2:[time]}")+";"),
				sublime.CompletionItem( #chatvisible
					...
					completion=case("chatvisible")+args("${1:<value>}")+";"),
				sublime.CompletionItem( #chatwidth
					...
					completion=case("chatwidth")+args("${1:<value}>,${2:[time]}")+";"),
				...
				sublime.CompletionItem( #config
					...
					completion=case("config")+args("${1:<configname>}")+";"),
				sublime.CompletionItem( #CONFIG
					trigger="CONFIG", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #controls
					...
					completion=case("controls")+args("[layout][:type]+")+";"),
				...
				sublime.CompletionItem( #craft
					...
					completion=case("craft")+args("${1:<item>}:${2:[damage]},${3:[amount]},${4:[throw]},${5:[verbose]}")+";"),
				sublime.CompletionItem( #craftandwait
					...
					completion=case("craftandwait")+args("${1:<item>}:${2:[damage]},${3:[amount]},${4:[throw]},${5:[verbose]}")+";"),
				...
				sublime.CompletionItem( #dec
					...
					completion=case("dec")+args("#${1:<var>},${2:[amount]}")+";"),
				sublime.CompletionItem( #decode
					...
					completion=case("decode")+args("${1:<input>},${2:[&output]}")+";"),
				...
				sublime.CompletionItem( #echo
					...
					completion=case("echo")+args("${1:<text>}")+";"),
				...
				sublime.CompletionItem( #encode
					...
					completion=case("encode")+args("${1:<input>},&${2:[output]}")+";"),
				...
				sublime.CompletionItem( #exec
					...
					completion=case("exec")+args("${1:<file.txt>},${2:[taskname]},${3:[params]}")+";"),
				...
				sublime.CompletionItem( #fog
					...
					completion=case("fog")+args("${1:[value]}")+";"),
				sublime.CompletionItem( #fov
					...
					completion=case("fov")+args("${1:<value>},${2:[time]}")+";"),
				sublime.CompletionItem( #FOV
					trigger="FOV", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #gamma
					...
					completion=case("gamma")+args("${1:<value>},${2:[time]}")+";"),
				sublime.CompletionItem( #GAMMA
					trigger="GAMMA", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #getid
					...
					completion=case("getid")+args("${1:<x>},${2:<y>},${3:<z>},&${4:[idvar]},#${5:[datavar]},&${6:[variants]}")+";"),
				sublime.CompletionItem( #getidrel
					...
					completion=case("getidrel")+args("${1:<dx>},${2:<dy>},${3:<dz>},&${4:[idvar]},#${5:[datavar]},&${6:[variants]}")+";"),
				sublime.CompletionItem( #getiteminfo
					trigger=case("getiteminfo"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=case("getiteminfo")+args("${1:<item>}:${2:[damage]},&${3:[namevar]},#${4:[maxstacksize]},&${5:[type]},&${6:[dropid]},#${7:[maxdurability]}")+";"),
				sublime.CompletionItem( #getproperty
					...
					completion=case("getproperty")+args("${1:<control>},${2:<property>}")+";"),
				sublime.CompletionItem( #getslot
					...
					completion=case("getslot")+args("${1:<item>}:${2:[damage]},#${3:<slotid>},${4:[startfromslotid]}")+";"),
				sublime.CompletionItem( #getslotitem
					trigger=case("getslotitem"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					annotation="",
					details="Gets information about the item in the specified slot", 
					completion=case("getslotitem")+args("${1:<slotid>},&${2:<idvar>},#${3:[stacksizevar]},#${4:[datavar]}")+";"),
				sublime.CompletionItem( #gui
					...
					completion=case("gui")+args("${1:[name]}")+";"),
				sublime.CompletionItem( #GUI
					trigger="GUI", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #iif
					...
					completion=case("iif")+args("${1:<condition>},${2:<truetext>},${3:[falsetext]}")+";"),
				sublime.CompletionItem( #import
					...
					completion=case("import")+args("${1:<configname>}")+";"),
				sublime.CompletionItem( #inc
					...
					completion=case("inc")+args("#${1:<var>},${2:[amount]}")+";"),
				sublime.CompletionItem( #indexof
					...
					completion=case("indexof")+args("${1:<array>}[],#${2:<outvar>},${3:<searchfor>},${4:[casesensitiv]}")+";"),
				sublime.CompletionItem( #inventorydown
					...
					completion=case("inventorydown")+args("${1:[amount]}")+";"),
				sublime.CompletionItem( #inventoryup
					...
					completion=case("inventoryup")+args("${1:[amount]}")+";"),
				...
				sublime.CompletionItem( #isrunning
					...
					completion=case("isrunning")+args("${1:<macro>}")+";"),
				...
				sublime.CompletionItem( #itemid
					...
					completion=case("itemid")+args("${1:<item>}")+";"),
				...
				sublime.CompletionItem( #itemname
					...
					completion=case("itemname")+args("${1:<id>}")+";"),
				...
				sublime.CompletionItem( #join
					...
					completion=case("join")+args("${1:<glue>},${2:<array>}[],&${3:[output]}")+";"),
				...
				sublime.CompletionItem( #key
					...
					completion=case("key")+args("${1:<bind>}")+";"),
				sublime.CompletionItem( #keydown
					...
					completion=case("keydown")+args("${1:<bind>}")+";"),
				...
				sublime.CompletionItem( #keyup
					...
					completion=case("keyup")+args("${1:<bind>}")+";"),
				sublime.CompletionItem( #lcase
					...
					completion=case("lcase")+args("${1:<input>},&${2:[output]}")+";"),
				...
				sublime.CompletionItem( #log
					...
					completion=case("log")+args("${1:<text>}")+";"),
				sublime.CompletionItem( #lograw
					...
					completion=case("lograw")+args("${1:<json>}")+";"),
				sublime.CompletionItem( #logto
					...
					completion=case("logto")+args("${1:<target>},${2:<text>}")+";"),
				sublime.CompletionItem( #look
					...
					completion=case("look")+args("${1:<yaw>},${2:[pitch]},${3:[time]}")+";"),
				sublime.CompletionItem( #looks
					...
					completion=case("looks")+args("${1:<yaw>},${2:[pitch]},${3:[time]}")+";"),
				...
				sublime.CompletionItem( #match
					...
					completion=case("match")+args("${1:<subject>},${2:<pattern>},&${3:[target]},${4:[group]},${5:[default]}")+";"),
				sublime.CompletionItem( #match alt
					...
					details="Runs a regular expression match on the subject", 
					completion=case("match")+args("${1:<subject>},${2:<pattern>},{${3:&target1,&target2...}}")+";"),
				sublime.CompletionItem( #match alt 2
					...
					details="Runs a regular expression match on the subject", 
					completion=case("match")+args("${1:<subject>},${2:<pattern>},&${3:[target]}[]")+";"),
				...
				sublime.CompletionItem( #modify
					...
					completion=case("modify")+args("${1:<newmessage>}")+";"),
				...
				sublime.CompletionItem( #music
					...
					completion=case("music")+args("${1:<value>},${2:[time]}")+";"),
				...
				sublime.CompletionItem( #pick
					...
					completion=case("pick")+args("${1:<item>}:${2:[damage]},${3:<item>}:${4:[damage]}${5:,...}")+";"),
				...
				sublime.CompletionItem( #placesign
					...
					completion=case("placesign")+args("${1:[line1]},${2:[line2]},${3:[line3]},${4:[line4]},${5:[showgui]}")+";"),
				...
				sublime.CompletionItem( #playsound
					...
					completion=case("playsound")+args("${1:<sound>},${2:[volume]}")+";"),
				sublime.CompletionItem( #pop
					...
					completion=case("pop")+args("${1:<array>}[],${2:<outvar>}")+";"),
				sublime.CompletionItem( #popupmessage
					...
					completion=case("popupmessage")+args("${1:<message>},${2:[animate]}")+";"),
				sublime.CompletionItem( #press
					...
					completion=case("press")+args("${1:<lwjgl_name>},${2:[deep]}")+";"),
				sublime.CompletionItem( #prompt
					...
					completion=case("prompt")+args("&${1:<target>},${2:<paramstring>},${3:[prompt]},${4:[override]},${5:[default]}")+";"),
				...
				sublime.CompletionItem( #push
					...
					completion=case("push")+args("${1:<array>}[],${2:<value>}")+";"),
				sublime.CompletionItem( #put
					...
					completion=case("put")+args("${1:<array>}[],${2:<value>}")+";"),
				...
				sublime.CompletionItem( #random
					...
					completion=case("random")+args("#${1:<target>},${2:[max]},${3:[min]}")+";"),
				...
				sublime.CompletionItem( #regexreplace
					...
					completion=case("regexreplace")+args("&${1:<subject>},${2:<pattern>},${3:[replace]}")+";"),
				...
				sublime.CompletionItem( #replace
					...
					completion=case("replace")+args("&${1:<subject>},${2:<search>},${3:[replace]}")+";"),
				sublime.CompletionItem( #resourcepacks
					...
					completion=case("resourcepacks")+args("${1:[pattern]},${2:[pattern...]}")+";"),
				sublime.CompletionItem( #RESOURCEPACKS
				...
				sublime.CompletionItem( #selectchannel
					...
					completion=case("selectchannel")+args("${1:<channel>}")+";"),
				sublime.CompletionItem( #sendmessage
					trigger=case("sendmessage"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=case("sendmessage")+args("${1:[params]}")+";"),
				...
				sublime.CompletionItem( #sensitivity
					...
					completion=case("sensitivity")+args("${1:<value>},${2:[time]}")+";"),
				...
				sublime.CompletionItem( #set
					...
					completion=case("set")+args("${1:<target>},${2:[value]}")+";"),
				sublime.CompletionItem( #setlabel
					...
					completion=case("setlabel")+args("${1:<labelname>},${2:<text>},${3:[binding]}")+";"),
				sublime.CompletionItem( #setproperty
					...
					completion=case("setproperty")+args("${1:<control>},${2:<property>},${3:<value>}")+";"),
				sublime.CompletionItem( #setres
					...
					completion=case("setres")+args("${1:<width>},${2:<height>}")+";"),
				sublime.CompletionItem( #setslotitem
					trigger=case("setslotitem"), 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_KEYWORD, 
					...
					completion=case("setslotitem")+args("${1:<item>}:${2:[damage]},${3:[slot]},${4:[amount]}")+";"),
				...
				sublime.CompletionItem( #shadergroup
					...
					completion=case("shadergroup")+args("${1:[path]}")+";"),
				...
				sublime.CompletionItem( #showgui
					...
					completion=case("showgui")+args("${1:<screen>},${2:[esc_screen]},${3:[macro_keys]}")+";"),
				...
				sublime.CompletionItem( #slot
					...
					completion=case("slot")+args("${1:<slot>}")+";"),
				sublime.CompletionItem( #slotclick
					...
					completion=case("slotclick")+args("${1:<slot>},${2:[button]},${3:[shift]}")+";"),
				...
				sublime.CompletionItem( #split
					...
					completion=case("split")+args("${1:<delimiter>},${2:<source>},${3:[output]}[]")+";"),
				...
				sublime.CompletionItem( #sqrt
					...
					completion=case("sqrt")+args("${1:<value>},#${2:[outvar]}")+";"),
				...
				sublime.CompletionItem( #stop
					...
					completion=case("stop")+args("${1:[id]}")+";"),
				sublime.CompletionItem( #store
					...
					completion=case("store")+args("${1:<type>},${2:[name]}")+";"),
				sublime.CompletionItem( #storeover
					...
					annotation="",
					details="Stores a value into one of the predefined parameter lists", 
					completion=case("storeover")+args("${1:<type>},${2:[name]}")+";"),
				sublime.CompletionItem( #strip
					...
					completion=case("strip")+args("&${1:<target>},${2:<text>}")+";"),
				...
				sublime.CompletionItem( #tileid
					...
					completion=case("tileid")+args("${1:<item>}")+";"),
				sublime.CompletionItem( #tilename
					...
					completion=case("tilename")+args("${1:<id>}")+";"),
				sublime.CompletionItem( #time
					...
					completion=case("time")+args("&${1:<target>},${2:[format]}")+";"),
				sublime.CompletionItem( #TIME
					trigger="TIME", 
					completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
					kind=sublime.KIND_VARIABLE, 
				...
				sublime.CompletionItem( #title
					...
					completion=case("title")+args("${1:[title]},${2:[subtitle]},${3:[inticks]},${4:[showticks]},${5:[outticks]}")+";"),
				sublime.CompletionItem( #toast
					...
					completion=case("toast")+args("${1:[type]},${2:[icon]},${3:[text1]},${4:[text2]},${5:[ticks]}")+";"),
				sublime.CompletionItem( #toggle
					...
					completion=case("toggle")+args("${1:[flag]}")+";"),
				sublime.CompletionItem( #togglekey
					...
					completion=case("togglekey")+args("${1:<bind>}")+";"),
				...
				sublime.CompletionItem( #type
					...
					completion=case("type")+args("${1:<text>}")+";"),
				sublime.CompletionItem( #ucase
					...
					completion=case("ucase")+args("${1:<input>},&${2:[output]}")+";"),
				...
				sublime.CompletionItem( #unset
					...
					completion=case("unset")+args("${1:<flag>}")+";"),
				...
				sublime.CompletionItem( #volume
					...
					completion=case("volume")+args("${1:<value>},${2:[category]}")+";"),
				sublime.CompletionItem( #wait
					...
					completion=case("wait")+args("${1:<time>}")+";"),
				sublime.CompletionItem( #walkto
					...
					completion=case("walkto")+args("${1:<x>},${2:<y>},${3:<z>},${4:[speed]},${5:[radius]}")+";"),
