	...
	def on_query_completions(self, view, prefix, locations):
		if view.match_selector(view.line(locations[0]).a, "comment.mkb"):
			...
			if in_string:
				...
				string_completions.extend([sublime.CompletionItem(annotation="(Blocks)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in blocks])
				string_completions.extend([sublime.CompletionItem(annotation="(Effects)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in effects])
				string_completions.extend([sublime.CompletionItem(annotation="(Enchantments)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in enchantments])
				string_completions.extend([sublime.CompletionItem(annotation="(Entities)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in entities])
				string_completions.extend([sublime.CompletionItem(annotation="(Foods)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in foods])
				string_completions.extend([sublime.CompletionItem(annotation="(Items)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in items])
				string_completions.extend([sublime.CompletionItem(annotation="(Particles)",trigger=i,completion="minecraft:"+i,completion_format=sublime.COMPLETION_FORMAT_SNIPPET,kind=sublime.KIND_VARIABLE) for i in particles])
