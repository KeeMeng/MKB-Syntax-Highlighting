	...
	def on_query_completions(self, view, prefix, locations):
		if view.match_selector(view.line(locations[0]).a, "comment.mkb"):
			...
			# Custom functions completions
				...
				] if module_bool("functions") and module_bool("klacaiba") else [] )
				+
				([
			# AEI Module
					sublime.CompletionItem( #getiteminfo
			...
			# HTTP Module
				...
				+
				([
			# Hypixeladditions Module
					sublime.CompletionItem( #P
						trigger="P", 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_VARIABLE, 
						annotation="(HypixelAdditions Module)", 
						details="Paragraph character", 
						completion=var_wrap+"P"+var_wrap+semicolon), 
					sublime.CompletionItem( #DOLLAR
						trigger="DOLLAR", 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_VARIABLE, 
						annotation="(HypixelAdditions Module)", 
						details="Dollar character", 
						completion=var_wrap+"DOLLAR"+var_wrap+semicolon), 
					sublime.CompletionItem( #DOLLARS
						trigger="DOLLARS", 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_VARIABLE, 
						annotation="(HypixelAdditions Module)", 
						details="Dollar characters", 
						completion=var_wrap+"DOLLARS"+var_wrap+semicolon), 
					sublime.CompletionItem( #MODULEHYPIXELADDITIONS
						trigger="MODULEHYPIXELADDITIONS", 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_VARIABLE, 
						annotation="(HypixelAdditions Module)", 
						details="Returns true if the HypixelAdditions module is installed", 
						completion=var_wrap+"MODULEHYPIXELADDITIONS"+var_wrap+semicolon), 
					sublime.CompletionItem( #getmapdata
						trigger=case("getmapdata"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:data} = "+case("getmapdata()")+semicolon), 
					sublime.CompletionItem( #getclipboard
						trigger=case("getclipboard"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:str} = "+case("getclipboard()")+semicolon), 
					sublime.CompletionItem( #setclipboard
						trigger=case("setclipboard"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("setclipboard")+args("&${1:<str>}")+semicolon), 
					sublime.CompletionItem( #getslotitemext
						trigger=case("getslotitemext"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=optional("&${1:[display_name]} = ")+case("getslotitemext")+args("#${2:<slot>},&${3:[id]},#${4:[stack]},#${5:[metadata]},&${1:[display_name]}")+semicolon), 
					sublime.CompletionItem( #getslotitemnbt
						trigger=case("getslotitemnbt"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
					...
					sublime.CompletionItem( #getslotitemenchants
						...
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=optional("&${1:[enchants]} = ")+case("getslotitemenchants")+args("#${2:<slot>},&${3:[id]},#${4:[stack]},#${5:[metadata]},&${1:[enchants]}")+semicolon), 
					sublime.CompletionItem( #getslotiteminv
						...
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=optional("&${1:[id]} = ")+case("getslotiteminv")+args("#${2:<slot>},&${1:[id]},#${3:[stack]},#${4:[metadata]},&${5:[nbt]}")+semicolon), 
					sublime.CompletionItem( #getchestname
						...
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:name} = "+case("getchestname()")+semicolon), 
					sublime.CompletionItem( #setanviltext
						trigger=case("setanviltext"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("setanviltext")+args("&${1:<text>}")+semicolon), 
					sublime.CompletionItem( #getmacrotype
						trigger=case("getmacrotype"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=optional("&${1:type} = ")+case("getmacrotype")+args("#${2:<keyID>}")+semicolon), 
					sublime.CompletionItem( #getmkbkeybind
						trigger=case("getmkbkeybind"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:keybind} = "+case("getmkbkeybind")+args("#${2:<keyID>}")+semicolon), 
					sublime.CompletionItem( #require
						trigger=case("require"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("require")+args("#${1:<keyID>},${2:<CTRL/SHIFT/ALT>}")+semicolon), 
					sublime.CompletionItem( #setmacrotype
						trigger=case("setmacrotype"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("setmacrotype")+args("#${1:<keyID>},${2:<ONESHOT/KEYSTATE/CONDITIONAL>}")+semicolon), 
					sublime.CompletionItem( #setmkbkeybind
						trigger=case("setmkbkeybind"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("setmkbkeybind")+args("#${1:<keyID>},${2:<mkbCode>}")+semicolon), 
					sublime.CompletionItem( #centralize
						trigger=case("centralize"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("centralize")+args("#${1:[x]},#${2:[y]},#${3:[z]}")+semicolon), 
					sublime.CompletionItem( #char
						trigger=case("char"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:char} = "+case("char")+args("${2:#<charInt>}")+semicolon), 
					...
					sublime.CompletionItem( #setwindowtitle
						trigger=case("setwindowtitle"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("setwindowtitle")+args("&${1:<title>}")+semicolon), 
					sublime.CompletionItem( #takescreenshot
						trigger=case("takescreenshot"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("takescreenshot")+args("${1:[true/false]}")+semicolon), 
					sublime.CompletionItem( #render
						trigger=case("render"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("render()")+semicolon), 
					sublime.CompletionItem( #unrender
						trigger=case("unrender"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("unrender()")+semicolon), 
					sublime.CompletionItem( #renderzero
						trigger=case("renderzero"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("renderzero")+args("#${1:[chunks]}")+semicolon), 
					sublime.CompletionItem( #getitemstacksize
						...
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("getitemstacksize")+args("&${1:<item>},#${2:[limit_search]}")+semicolon), 
					sublime.CompletionItem( #getpercentage
						...
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion=case("getpercentage")+args("#${1:<int1>},#${2:<int2>}")+semicolon), 
					sublime.CompletionItem( #getbalance
						trigger=case("getbalance"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:coins} = "+case("getbalance()")+semicolon), 
					sublime.CompletionItem( #getbits
						trigger=case("getbits"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:bits} = "+case("getbits()")+semicolon), 
					sublime.CompletionItem( #getlocation
						trigger=case("getlocation"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:location} = "+case("getlocation()")+semicolon), 
					sublime.CompletionItem( #getscoreboard
						trigger=case("getscoreboard"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:scoreboard} = "+case("getscoreboard()")+semicolon), 
					sublime.CompletionItem( #gettablistfooter
						trigger=case("gettablistfooter"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:footer} = "+case("gettablistfooter()")+semicolon), 
					sublime.CompletionItem( #gettablistheader
						trigger=case("gettablistheader"), 
						completion_format=sublime.COMPLETION_FORMAT_SNIPPET, 
						kind=sublime.KIND_KEYWORD, 
						annotation="(HypixelAdditions Module)", 
						details="", 
						completion="&${1:header} = "+case("gettablistheader()")+semicolon), 
			...
			if in_string:
				...
				if settings.get("mc_id"):
					...
					effects = ["Speed","Slowness","Haste","MiningFatigue","Strength","InstantHealth","InstantDamage","JumpBoost","Nausea","Regeneration","Resistance","FireResistance","WaterBreathing","Invisibility","Blindness","NightVision","Hunger","Weakness","Poison","Wither","HealthBoost","Absorption","Saturation","Glowing","Levitation","Luck","BadLuck"]
